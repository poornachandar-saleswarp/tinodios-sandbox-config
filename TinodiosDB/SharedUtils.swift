...
public class SharedUtils {
    ...
    #if DEBUG
        public static let kDefaultHostName = "sandbox.tinode.co" // sandbox server
    ...
    public static func registerUserDefaults() {
        ...
        // Force reset connection settings to use current build configuration
        let (hostName, _) = getConnectionSettings()
        if hostName == nil || hostName == "127.0.0.1:6060" {
            // If hostname is nil or still localhost, sync values to defaults
